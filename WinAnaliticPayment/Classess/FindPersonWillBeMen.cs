...
namespace WinAnaliticPayment.Classess
{
    public class FindPersonWillBeMen : IQuery
    {
        ...
        public FindPersonWillBeMen(string dateStartBirth, string dateEndBirth)
        {
...
AND (WM_PERSONAL_CARD.A_STATUS = 10) AND 
					  ...
					  and WM_PERSONAL_CARD.A_SEX = 1 and and (WM_PERSONAL_CARD.BIRTHDATE >= '" + this.dateStartBirth + "' and WM_PERSONAL_CARD.BIRTHDATE <= '" + this.dateEndBirth + "') " +
