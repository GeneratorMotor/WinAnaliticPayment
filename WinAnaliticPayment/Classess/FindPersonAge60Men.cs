...
{
    public class FindPersonAge60Men : IQuery
    {
        // Дата рождения мужика на 1 ое число текущего месяца - 60 лет. 
        // Пример на 25 октября 2021 мы задаем ДР мужика на <= 1 октября 1961 г.
        private string dateBirth = string.Empty;
        private int idLk = 0;

        public FindPersonAge60Men(string dateBirth, int idLk)
        {
