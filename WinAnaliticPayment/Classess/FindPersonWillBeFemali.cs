...
{
    public class FindPersonWillBeFemali : IQuery// PersonWillBeAge55and60
    {
        private string dateStartBirth = string.Empty;
        private string dateEndBirth = string.Empty;
        private int idLk = 0;

        public FindPersonWillBeFemali(string dateStartBirth, string dateEndBirth, int idLk)
        {
...
AND (WM_PERSONAL_CARD.A_STATUS = 10) AND 
					  ...
					  and WM_PERSONAL_CARD.A_SEX = 2 and (WM_PERSONAL_CARD.BIRTHDATE >= '" + this.dateStartBirth +"' and WM_PERSONAL_CARD.BIRTHDATE <= '"+ this.dateEndBirth +"') " +
