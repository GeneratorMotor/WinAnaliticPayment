...
namespace WinAnaliticPayment.Classess
{
    public class FindPersonWillBeFemali : IQuery// PersonWillBeAge55and60
    {
        ...
        public FindPersonWillBeFemali(string dateStartBirth, string dateEndBirth)
        {
...
AND (WM_PERSONAL_CARD.A_STATUS = 10) AND 
					  ...
					  and WM_PERSONAL_CARD.A_SEX = 2 and and (WM_PERSONAL_CARD.BIRTHDATE >= '"+ this.dateStartBirth +"' and WM_PERSONAL_CARD.BIRTHDATE <= '"+ this.dateEndBirth +"') " +
